# work_item 첨부 파일 목록 조회 api
- 특정 work_item에 첨부된 모든 파일 목록을 조회하는 api
## Request
- Request syntax
```json
{
...
| Method | URL |
| :--- | :--- |
| Get | http://{서버 url}/api/workItems/files?work_item_id=WI-104 |
...
| 파라미터 | 타입 | 필수 여부 | 설명 |
| :--- | :--- | :--- | :--- |
| work_item_id | String | 필수 | 파일 목록을 조회할 work_item 식별 id |
...
| data | Array | 성공 | 조회된 첨부 파일 메타데이터 목록 |
...
| 파라미터 | 타입 | 필수 여부 | 설명 |
| :--- | :--- | :--- | :--- |
| file_id | Integer | 필수 | 첨부 파일 식별 id |
