...
class AuthController : public drogon::HttpController<AuthController>
{
  public:
    ...
    // METHOD_ADD(AuthController::get, "/{2}/{1}", Get); // path is /api/v1/AuthController/{arg2}/{arg1}
    // METHOD_ADD(AuthController::your_method_name, "/{1}/{2}/list", Get); // path is /api/v1/AuthController/{arg1}/{arg2}/list
    // ADD_METHOD_TO(AuthController::your_method_name, "/absolute/path/{1}/{2}/list", Get); // path is /absolute/path/{arg1}/{arg2}/list

    ADD_METHOD_TO(AuthController::loginUser, "/api/v1/users/login", Post);    
