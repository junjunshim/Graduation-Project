...
| :--- | :--- | :--- | :--- | :--- |
| 회원가입 | Post | /api/v1/users | 진행중 |  |
| Org 최상위 노드 | Post | /api/v1/topNodes | 진행중 |  |
| Org 하위 노드 | Post | /api/v1/subNodes | 진행중 |  |
| Role 부여 | Post | /api/v1/roles | 진행중 |  |
| work_item 생성 | Post | /api/v1/workItems | 진행중 |  |
