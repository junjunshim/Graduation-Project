...
class OrgController : public drogon::HttpController<OrgController>
{
  public:
    ...
    ADD_METHOD_TO(OrgController::previewNodeMove, "/api/org/nodes/move-preview", Post, "JwtFilter");
    ADD_METHOD_TO(OrgController::moveNode, "/api/org/nodes/move", Patch, "JwtFilter");
    ...
    void previewNodeMove(const HttpRequestPtr &req, std::function<void(const HttpResponsePtr &)> &&callback);
    void moveNode(const HttpRequestPtr &req, std::function<void(const HttpResponsePtr &)> &&callback);
